...
define(['./workbox-5f162ca1'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "index.html",
    "revision": "0.bv5qmiq0oag"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/\/patient-profile/, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/\/awareness/, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/\/first-aid/, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/\/doctor-dashboard/, new workbox.CacheFirst({
